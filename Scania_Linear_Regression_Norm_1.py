...
print(f"\nMLR NMSE Total Value: {NMSE(X_test, y_hat_mlr):0.4f}")
print(f"\nGLR NMSE Total Value: {NMSE(X_test, y_hat_glr):0.4f}")

print(f"\nSLR NMSE y=0 Value: {NMSE(X_test[y_test == 0], y_hat_slr[y_test == 0]):0.4f}")
print(f"\nMLR NMSE y=0 Value: {NMSE(X_test[y_test == 0], y_hat_mlr[y_test == 0]):0.4f}")
print(f"\nGLR NMSE y=0 Value: {NMSE(X_test[y_test == 0], y_hat_glr[y_test == 0]):0.4f}")

print(f"\nSLR NMSE y=1 Value: {NMSE(X_test[y_test == 1], y_hat_slr[y_test == 1]):0.4f}")
print(f"\nMLR NMSE y=1 Value: {NMSE(X_test[y_test == 1], y_hat_mlr[y_test == 1]):0.4f}")
print(f"\nGLR NMSE y=1 Value: {NMSE(X_test[y_test == 1], y_hat_glr[y_test == 1]):0.4f}")
